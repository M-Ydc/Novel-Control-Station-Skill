...
记录叙述者的口音偏好（详见 [narrative-voice-construction.md](narrative-voice-construction.md) 第 2 节）：

- 核心偏好方向（叙述者最爱干什么）：拆台 / 摆帅 / 掘荒诞 / 拉家常 / 用毒 / 咏叹
- 比喻取料池主领域：市井日常 / 江湖生意 / 官场/职场 / 自然环境 / 家务/厨房 / 账房/财务 / 工匠/手艺
- 紧迫时刻句子变化规律：变短型 / 变长型 / 长短交替型
- 叙述者钝感项（至少一项）：战斗招式 / 功法原理 / 自然风景 / 服装外貌 / 食物器物 / 建筑陈设 / 内心剖析 / 政治格局
- 主角内心独白方向：自嘲型 / 观察者型 / 刻薄型 / 算账型 / 实用型 / 沉默型
- 口音类型参考（从 narrative-voice-construction.md 第 6 节选择）：吐槽解构型 / 冷峻画面型 / 沉稳记叙型 / 混合过渡型
